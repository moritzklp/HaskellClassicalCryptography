...
import MTP (hexToBytes, breakWithPartialKey, analyzeAllCiphertexts, createPartialKey)

-- | The provided challenge ciphertexts
sampleHexes :: [String]
sampleHexes = [ ""
  ...
  , ""]

-- | Normalize the ciphertexts using the first one as the target
normalizeToFirst :: [BS.ByteString] -> ([BS.ByteString], BS.ByteString)
normalizeToFirst [] = ([], BS.empty)
normalizeToFirst (first:rest) =
  let len = BS.length first
      normalized = map (BS.take len) (first : rest)
  in (normalized, first)

spec :: Spec
spec = do

  describe "Many-Time Pad Challenge" $ do
    it "Partially recovers plaintext from real challenge ciphertexts" $ do
      let ciphertexts = map hexToBytes sampleHexes
          normalized = map (BS.take 100) ciphertexts
          cWithSpaces = analyzeAllCiphertexts normalized
          emptyKey = replicate 100 Nothing
          partialKey = createPartialKey emptyKey cWithSpaces
          decrypted = breakWithPartialKey (BS.unpack (head normalized)) partialKey
